...
import com.emergentes.medicapp.directioshelpers.FetchURL;
import com.emergentes.medicapp.directioshelpers.TaskLoadedCallback;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, TaskLoadedCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lat_t = Double.parseDouble(getIntent().getStringExtra("latitud"));
        long_t = Double.parseDouble(getIntent().getStringExtra("longitud"));

        Log.i("VOLLEY","COORDENADAS: LAT:"+lat_t+" LON:"+long_t);
        name = getIntent().getStringExtra("nombre_cliente");
        id_pedido = getIntent().getStringExtra("idpedido");
        /**
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        marca1 = new MarkerOptions().position(new LatLng(lat_t, long_t)).title(name);
